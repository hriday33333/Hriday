...
export const metadata = {
  ...
  description:
    "Hriday: Expert Full Stack Developer specializing in React, JavaScript, and modern web technologies. Building responsive, high-performance web applications.",
  keywords: [
    "Hriday",
  ...
  openGraph: {
    title: "Hriday - Full Stack Developer | React & JavaScript Specialist",
    description:
...
const personJsonLd = {
  ...
  description:
    "MERN Stack Developer specializing in React, JavaScript, and modern web technologies",
};
...
const websiteJsonLd = {
  ...
  author: { "@type": "Person", name: "Hriday" },
};
