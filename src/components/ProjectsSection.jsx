...
const projects = [
  ...
  },
  {
    ...
    description:
      'SkillSwap is an online platform that connects learners with skill providers, offering easy skill discovery, booking, and secure user management.',
  ...
  },
  {
    ...
    description:
      'React web and mobile app to explore, track, and manage trending apps with clean UI and mobile-optimized design for a smooth user experience',
